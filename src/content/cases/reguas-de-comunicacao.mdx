...
Uma nova versão da régua de Confirmação, com três disparos em cadência diferente (24h, 18h e 4h antes do agendamento), está em desenvolvimento. Uma primeira tentativa de rollout em maio foi revertida após identificarmos um erro na regra de disparo no MKT Cloud — a estabilidade da régua atual em produção foi preservada enquanto o ajuste é feito. Re-entrega prevista pra fim de maio.
